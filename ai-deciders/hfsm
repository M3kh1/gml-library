...
{
	// add a return to state identifier ltr like: return_state
...
function transitionFSM(_event, _from, _toState, _toSubState) constructor
{
...
function controllerFSM(_name="Controller") constructor
{
	name = _name;
	showDebug = false;
...
function stateFSM(_name) constructor
{
	name = _name;
	showDebug = false;
	...
	addTransition = function(_eventName, _from, _toState, _toSubState)
	{
		...
		var _t = new transitionFSM(_eventName, _from, _toState, _toSubState);
...
// Actual Behaviors
function subStateFSM(_name) constructor
{
	name = _name;
